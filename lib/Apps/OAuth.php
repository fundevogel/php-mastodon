...
class OAuth extends ApiMethod
{
     ...
     * @return array
     */
    public function token(string $clientID, string $clientSecret, string $grantType = 'client_credentials', string $scope = 'read', string $code = '', string $redirectURI = 'urn:ietf:wg:oauth:2.0:oob'): array
    {
